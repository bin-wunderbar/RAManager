...
VALUES  ('12395678B', 'Charles', 'Francis Xabier', '2ac9cb7dc02b3c0083eb70898e549b63', 'Vizcaya', 'Bilbao 1, 2', 'charles.xabier@rekordautoak.com', '34111222333', 4),
		('22345678A', 'Ororo', 'Iqadi Munroe', '2ac9cb7dc02b3c0083eb70898e549b63', 'Vizcaya', 'Bilbao 2, 3', 'storm@rekordautoak.com', '34222333444', 2),
	    ('32345678A', 'Scott', 'Summers', '2ac9cb7dc02b3c0083eb70898e549b63', 'Vizcaya', 'Bilbao 3, 4', 'scott.summers@rekordautoak.com', '34333444555', 1),
		('42345678A', 'Erik', 'Lehnsherr', '2ac9cb7dc02b3c0083eb70898e549b63', 'Vizcaya', 'Bilbao 4, 5', 'magneto@rekordautoak.com', '34666777888', 3),
		('52345678A', 'Piotr', 'Nikolaievitch Rasputin,', '2ac9cb7dc02b3c0083eb70898e549b63', 'Vizcaya', 'Bermeo 6, 7', 'coloso@rekordautoak.com', '34999111222', 1),
		('11223344B', 'Henry', 'Philip McCoy', '2ac9cb7dc02b3c0083eb70898e549b63', 'Vizcaya', 'Basauri 1, 2', 'beast@rekordautoak.com', '34112222333', 4);
...
VALUES
        ('2020-03-22 10:00:00', 'Revision eléctrica', '2020-03-22 10:00:00', true, 1, 1, 3, 1),
		('2020-04-12 10:00:00', 'Problemas de batería', '2020-03-22 10:00:00', true, 1, 1, 5, 2),
		('2021-10-24 17:42:00', 'Rotura de luna trasera', '2020-03-22 10:00:00', true, 4, 4, 3, 3),
		('2020-03-22 10:00:00', 'Test1', '2020-03-22 10:00:00', true, 1, 1, 3, 1),
		('2020-03-22 10:00:00', 'Test2', '2020-03-22 10:00:00', true, 1, 1, 3, 2),
		('2020-03-22 00:00:00', 'Test3', null, true, 1, 1, 5, 3),
		('2020-03-22 10:00:00', 'Test3.1', '2020-03-22 10:00:00', true, 2, 1, 3, 3),
		('2020-03-22 10:00:00', 'Test4', '2020-03-22 10:00:00', true, 1, 1, 5, 4),
		('2020-03-22 10:00:00', 'Test5', '2020-03-22 10:00:00', true, 1, 1, 3, 5),
		('2020-03-22 10:00:00', 'Test6', '2020-03-22 10:00:00', true, 1, 1, 5, 6),
		('2022-01-23 10:30:00', 'Fallo intermitente delantero izquierdo', null, false, 1, 1, 3, 1);
